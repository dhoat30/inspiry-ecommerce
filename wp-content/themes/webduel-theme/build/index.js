...
/* harmony import */ var _modules_Form_Form__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/Form/Form */ "./src/modules/Form/Form.js");
/* harmony import */ var _modules_OwlCarousel_EveryOwlCarousel__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/OwlCarousel/EveryOwlCarousel */ "./src/modules/OwlCarousel/EveryOwlCarousel.js");
/* harmony import */ var _modules_Warranty__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/Warranty */ "./src/modules/Warranty.js");
/* harmony import */ var _modules_WallpaperCalc__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/WallpaperCalc */ "./src/modules/WallpaperCalc.js");
/* harmony import */ var _modules_DesignBoardSaveBtn__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/DesignBoardSaveBtn */ "./src/modules/DesignBoardSaveBtn.js");
/* harmony import */ var _modules_overlay__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/overlay */ "./src/modules/overlay.js");
/* harmony import */ var _modules_TopNav__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/TopNav */ "./src/modules/TopNav.js");
/* harmony import */ var _modules_ShopFav__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/ShopFav */ "./src/modules/ShopFav.js");
/* harmony import */ var _modules_ToolTip__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/ToolTip */ "./src/modules/ToolTip.js");
/* harmony import */ var _modules_PopUpCart__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/PopUpCart */ "./src/modules/PopUpCart.js");
/* harmony import */ var _modules_Product__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/Product */ "./src/modules/Product.js");
/* harmony import */ var _modules_EnquiryModal_EnquiryModal__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/EnquiryModal/EnquiryModal */ "./src/modules/EnquiryModal/EnquiryModal.js");
/* harmony import */ var _modules_CartModal_CartModal__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/CartModal/CartModal */ "./src/modules/CartModal/CartModal.js");
/* harmony import */ var _modules_Auth_Login__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/Auth/Login */ "./src/modules/Auth/Login.js");
/* harmony import */ var _modules_Windcave_CheckoutInputValidation__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./modules/Windcave/CheckoutInputValidation */ "./src/modules/Windcave/CheckoutInputValidation.js");
...
/* harmony import */ var _modules_FacetFilter_FacetFilter__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./modules/FacetFilter/FacetFilter */ "./src/modules/FacetFilter/FacetFilter.js");
/* harmony import */ var _modules_CustomerService_CustomerServiceMenu__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./modules/CustomerService/CustomerServiceMenu */ "./src/modules/CustomerService/CustomerServiceMenu.js");
/* harmony import */ var _modules_CustomerService_ContactForm__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./modules/CustomerService/ContactForm */ "./src/modules/CustomerService/ContactForm.js");
/* harmony import */ var _modules_CustomerService_FeedbackForm__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./modules/CustomerService/FeedbackForm */ "./src/modules/CustomerService/FeedbackForm.js");
...
window.onload = function () {
  ...
  const enquiryModal = new _modules_EnquiryModal_EnquiryModal__WEBPACK_IMPORTED_MODULE_13__["default"](); // cart modal 

  const cartModal = new _modules_CartModal_CartModal__WEBPACK_IMPORTED_MODULE_14__["default"](); // form data processing 

  const form = new _modules_Form_Form__WEBPACK_IMPORTED_MODULE_2__["default"](); //get product data and show in the quick view

  const product = new _modules_Product__WEBPACK_IMPORTED_MODULE_12__["default"](); // every owl carousel

  const everyOwlCarousel = new _modules_OwlCarousel_EveryOwlCarousel__WEBPACK_IMPORTED_MODULE_3__["default"]();
  const shopFav = new _modules_ShopFav__WEBPACK_IMPORTED_MODULE_9__["default"]();
  const topnav = new _modules_TopNav__WEBPACK_IMPORTED_MODULE_8__["default"]();
  const overlay = new _modules_overlay__WEBPACK_IMPORTED_MODULE_7__["default"]();
  const designBoardSaveBtn = new _modules_DesignBoardSaveBtn__WEBPACK_IMPORTED_MODULE_6__["default"]();
  const popUpCart = new _modules_PopUpCart__WEBPACK_IMPORTED_MODULE_11__["default"](); //Tool tip 

  const toolTip = new _modules_ToolTip__WEBPACK_IMPORTED_MODULE_10__["default"](); // login 

  const login = new _modules_Auth_Login__WEBPACK_IMPORTED_MODULE_15__["default"](); // search 

  const search = new _modules_Search__WEBPACK_IMPORTED_MODULE_17__["default"](); // facet filter 

  const facetFilter = new _modules_FacetFilter_FacetFilter__WEBPACK_IMPORTED_MODULE_18__["default"](); // customer service 

  const customerServiceMenu = new _modules_CustomerService_CustomerServiceMenu__WEBPACK_IMPORTED_MODULE_19__["default"]();
  const contactForm = new _modules_CustomerService_ContactForm__WEBPACK_IMPORTED_MODULE_20__["default"]();
  const feedbackForm = new _modules_CustomerService_FeedbackForm__WEBPACK_IMPORTED_MODULE_21__["default"](); //price 
...
const warranty = new _modules_Warranty__WEBPACK_IMPORTED_MODULE_4__["default"]();
const wallpaperCalc = new _modules_WallpaperCalc__WEBPACK_IMPORTED_MODULE_5__["default"](); // typewriter effect
...
$(document).on('click', '#place_order', e => {
  if (onChangeValue === 'inspiry_payment' || windcavePaymentSelected === 'inspiry_payment') {
    ...
    const checkoutInputValidation = new _modules_Windcave_CheckoutInputValidation__WEBPACK_IMPORTED_MODULE_16__["default"](); // check if the terms and conditions is checked 
