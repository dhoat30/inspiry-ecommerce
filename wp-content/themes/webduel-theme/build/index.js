...
/* harmony import */ var _modules_Product__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/Product */ "./src/modules/Product.js");
...
const errorModal = new _modules_ErrorModal_ErrorModal__WEBPACK_IMPORTED_MODULE_26__["default"]();

window.onload = function () {
  // checkout 
  const checkout = new _modules_Woocommerce_Checkout_Checkout__WEBPACK_IMPORTED_MODULE_27__["default"](); // enquiry modal 

  const enquiryModal = new _modules_EnquiryModal_EnquiryModal__WEBPACK_IMPORTED_MODULE_12__["default"](); // cart modal 

  const cartModal = new _modules_CartModal_CartModal__WEBPACK_IMPORTED_MODULE_13__["default"](); // form data processing 

  const form = new _modules_Form_Form__WEBPACK_IMPORTED_MODULE_1__["default"](); //get product data and show in the quick view

  const product = new _modules_Product__WEBPACK_IMPORTED_MODULE_11__["default"]();
