            ...
            <div class="banner-card owl-carousel">
                ...
                while($banner->have_posts()){ 
                    ...
                    if(get_field('banner_link')){
                        ?>
                                        <a href="<?php echo get_field('banner_link');?>" class="banner-link"> <?php echo get_the_title(); ?> LEARN <i class="fal fa-chevron-right white"></i></a>

                        <?php
                    }
                    else{
                        ?>
                        <a href="<?php echo get_field('banner_link');?>" class="banner-link"> <?php echo get_the_title(); ?></a>
                        <?php
                    }
                } 
                wp_reset_postdata();
